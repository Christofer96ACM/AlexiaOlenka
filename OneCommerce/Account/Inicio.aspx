<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="OneCommerce.Account.Inicio" %>
                    ...
                    <dx:LayoutItem Caption="Alexia Cloud" ShowCaption="False">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="licMain" runat="server" 
                                ...
                                <img style="width:800px; height:600px;" src="../Content/Images/Alexia-plataforma.jpg" />
