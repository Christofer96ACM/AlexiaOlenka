...
namespace OneCommerce.Mikrotik
{
    public partial class Consumos : Page
    {
        ...
        protected void grdvConsumos_RowUpdating(object sender, ASPxDataUpdatingEventArgs e)
        {

        }

        protected void grdvConsumos_RowInserting(object sender, ASPxDataInsertingEventArgs e)
        {

        }

        protected void grdvConsumos_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
