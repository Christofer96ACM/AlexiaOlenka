                                ...
                                <table>
                                    <tr>
                                       ...
                                       <ClientSideEvents CheckedChanged="Clear_RangeDate" />
                                        ...
                                        <dx:ASPxDateEdit ID="dterdDateIn" runat="server" Width="135px" 
                                            ClientInstanceName="dterdDateIn">
                                        </dx:ASPxDateEdit>
                                    </td>
                                    <td style="width:130px">
                                        <dx:ASPxDateEdit ID="dterdDateFi" runat="server" Width="135px" 
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:80px;" colspan="2">
                                            <dx:ASPxTextBox ID="txtDireccion" runat="server" Width="280px" 
                                                ClientInstanceName="txtDireccion" ClientSideEvents-KeyUp="Get_Plan2"  AutoPostBack="false">
                                            </dx:ASPxTextBox>
                                        </td>
                                        ...
                                        <td style="font-weight:bold;">
                                         ...
                                         <td colspan="2" style="width:120px">
                                           <dx:ASPxComboBox ID="cbbssede" runat="server" EnableSynchronization="False"
                                            ClientInstanceName="cbbssede" Width="100px" ClientSideEvents-SelectedIndexChanged="cambio_sede"
                                        ...
                                        <td style="width:100px;"></td>
                                         ...
                                         <td style="width:20px;"></td>
                                         <td>
                                            <dx:ASPxButton ID="btnEnviarTodo" runat="server" Width="100%" Text="Enviar Todos" 
                                                ClientInstanceName="btnEnviarTodo"  AutoPostBack="false" OnClick="btnEnviarTodo_Click">
                                                    ...
                                                    >
                                                      ...
                                                      <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Mac Equipo" PropertiesTextEdit-ClientInstanceName="U_DXP_MAC_EQUIPO"
                                                         ...
                                                         <dx:GridViewDataCheckColumn VisibleIndex="13" UnboundType="String" Caption="Estado Internet" FieldName="U_DXP_ESTADO_INT">
