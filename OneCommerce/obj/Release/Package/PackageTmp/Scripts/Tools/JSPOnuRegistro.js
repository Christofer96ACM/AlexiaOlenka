...
function Get_InitialData() {
    ...
    {
        type: "POST",
        url: "../RegistroOnus/Registro.aspx/Get_InitialData",
        data: '{"socied":"' + socied + '"}',
...
function cambio_sede() {
    grdvOnusRegistro.PerformCallback("CHANGE");
}
...
function Get_Plan() {
    ...
    grdvOnusRegistro.PerformCallback("INIT");
}
function Get_Plan2() {
...
function OnGetRowValuesPlanes(values) {
    U_DXP_ONU_TYPE.SetText(values[0]);
