...
function OkProduct() {
    ...
    if (rowc === 0) {
        ...
        gdvProductSearch.GetRowValues(gdvProductSearch.GetFocusedRowIndex(), "ItemCode;ItemName;OnHand;PriceBefDi;DiscPrcnt;Price;PriceVat;IssueMthd;NumInSale;ActivoC;ActivoS;InvntItem;PLAN", OnGetRowValuesProduct);
    }
}
...
function Com_Operation(s, e) {
    ...
    else if (e.result.indexOf("SIU") !== -1) {
        _spd = e.result.split("#");
        txtDocEntry.SetText(_spd[1]);
        txtDocNum.SetText(_spd[2]);
        EnabledControl(false);
