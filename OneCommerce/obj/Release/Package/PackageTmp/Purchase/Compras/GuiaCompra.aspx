<%@ Page Title="Guia de Remision" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="GuiaCompra.aspx.cs" Inherits="OneCommerce.Compras.GuiaCompra" %>
...
<script type="text/javascript" src="../Scripts/Compras/GuiaCompra2.js"></script>
                                        ...
                                        <tr>
					                            ...
					                            <table style="width:500px" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="width:200px">
                                                            ...
                                                            ClientInstanceName="cbbU_BPP_MDTD" Visible="false">
                                                        ...
                                                        <td style="width:100px">
                                                            <dx:ASPxComboBox ID="cbbU_BPP_MDSD" runat="server" EnableSynchronization="False"
                                                                ClientInstanceName="cbbU_BPP_MDSD" Width="100px" Visible="false">
                                            ...
                                            <td style="width:217px">
                                                <dx:ASPxTextBox ID="txtNumAtCard" runat="server" Width="197px"
                                                    ClientInstanceName="txtNumAtCard" ReadOnly="true" Visible="false">
                                                    <ReadOnlyStyle Font-Bold="true"></ReadOnlyStyle>
                                                </dx:ASPxTextBox>
                                            </td>
                                        </tr>                                        
                                                ...
                                                <dx:ASPxGridView ID="gdvdln1" runat="server" AutoGenerateColumns="False" Width="1022px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Moneda" FieldName="LastPurCur"
                                                            ShowInCustomizationForm="True" VisibleIndex="12" Width="50px">
