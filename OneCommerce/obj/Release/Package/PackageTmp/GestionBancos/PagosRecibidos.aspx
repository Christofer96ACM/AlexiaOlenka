<%@ Page Title="Pagos Recibidos" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="PagosRecibidos.aspx.cs" Inherits="OneCommerce.GestionBancos.PagosRecibidos" %>
...
<script type="text/javascript" src="../Scripts/GestionBancos/JSPagosRecibidos.js"></script>
...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity:"sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin:"anonymous">
    ...
    <dx:ASPxFormLayout runat="server" ID="frlMain" Height="800px"
        ...
        <Items>
            <dx:LayoutGroup Caption="Pagos Recibidos"  GroupBoxStyle-Caption-Font-Size="X-Large"
                                                ...
                                                <table id="tab1tabla1">
                                                    <tr>
                                                        ...
                                                        <td style="width:40px">
                                                            <dx:ASPxRadioButtonList ID="rbtnType" runat="server" Height="10px"
                                                                ...
                                                                <Items>
                                                                    <dx:ListEditItem Text="Cliente" Value="Y" Selected="True" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:140px">
                                                            Fecha Documento:</td>
                                                        <td style="width:140px">
                                                            <dx:ASPxDateEdit ID="txtdocDate1" runat="server" Width="100%" ReadOnly="true"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxComboBox ID="cbbCurPagoTrans" runat="server" Width="200px" EnableSynchronization="False"
                                                    ...
                                                    ClientSideEvents-SelectedIndexChanged="cambio_moneda_pago3">
                                                    <Items>
                                                        <dx:ListEditItem Selected="True" Text="SOL" Value="SOL" />
                                                        <dx:ListEditItem Text="Dolar Americano" Value="USD" />
                                                        <dx:ListEditItem Text="Euro" Value="EUR" />
    ...
    <dx:ASPxPopupControl ID="ppcPRSearch" runat="server" 
        ClientInstanceName="ppcPRSearch" FooterText=" " HeaderText="Buscar Pago Recibido" 
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" 
