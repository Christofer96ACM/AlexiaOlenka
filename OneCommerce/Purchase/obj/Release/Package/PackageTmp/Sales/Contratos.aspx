                                ...
                                <table style="width:1200px; height:150px" class="tablespace">
                                    <tr>
                                        <td colspan="9" style="width:1200px">
                                            <dx:ASPxGridView ID="grdvContratos" runat="server" AutoGenerateColumns="False" Width="1200px"
                                                    ClientInstanceName="grdvContratos" KeyFieldName="AbsEntry" OnCommandButtonInitialize="grdvContratos_CommandButtonInitialize"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Numero Doc." PropertiesTextEdit-ClientInstanceName="DocNum"
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Calle" PropertiesTextEdit-ClientInstanceName="Street"
