<%@ Page Title="Tipo de Cambio" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="Limpio.aspx.cs" Inherits="OneCommerce.Limpio" %>
...
<script type="text/javascript" src="../Tools/JSContratos.js"></script>
                    ...
                    <dx:LayoutItem Caption="Datos Generales" ShowCaption="False">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="licMain" runat="server" 
                                ...
                                <table style="width:700px; height:150px" class="tablespace">
                                    <tr>
