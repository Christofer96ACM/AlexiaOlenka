                                            ...
                                            <section class="sectablas" id="tab3">
                                                <dx:ASPxGridView ID="gvDirecciones" runat="server" AutoGenerateColumns="False" Width="800px"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataCheckColumn VisibleIndex="12" UnboundType="String" Caption="Fiscal" FieldName="AdresType">
                                                            <PropertiesCheckEdit AllowGrayed="false" ValueChecked="B" ValueUnchecked="S" ValueType="System.String"></PropertiesCheckEdit>
                                                        </dx:GridViewDataCheckColumn>
                                                        <dx:GridViewDataCheckColumn VisibleIndex="13" UnboundType="String" Caption="Activo" FieldName="Active">
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="Línea" ShowInCustomizationForm="True" 
                                                            VisibleIndex="14" Width="0px" FieldName="LineNum">
                                                            <PropertiesTextEdit ClientInstanceName="LineNum"
                                                                DisplayFormatInEditMode="true">    </PropertiesTextEdit>                                           
                                                            <EditCellStyle HorizontalAlign="Right" VerticalAlign="Middle" Font-Size="8pt">
                                                            </EditCellStyle>
                                                            <HeaderStyle CssClass="DisplayNone" />
