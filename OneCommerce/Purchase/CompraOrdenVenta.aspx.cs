...
{
    public partial class CompraOrdenVenta : Page
    {
        ...
        protected void gdvAddress_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            if (e.Parameters.Contains("INICIAR"))
            {
                ...
                //var listcnct = obrd.Get_Contact_Person(obj);
                //listcnct.ForEach(i =>
                //{
                //    cbbPersonContact.Items.Add(i.Name, i.CntctCode);
                //});
                Session["crd1"] = olst;
            }
        ...
        protected void gdvrdr1_RowUpdating(object sender, ASPxDataUpdatingEventArgs e)
        {
            ...
            ((List<BEDocumentLine>)Session["rdr1"])[index].WhsCode = Convert.ToString(e.NewValues["WhsCode"]);
        ...
        protected void gdvrdr1_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            ...
            var _lnm = (i + 1);
            {
                ((List<BEDocumentLine>)Session["rdr1"]).RemoveAll(item => item.LineNum == _lnm);
            }
            Set_LineNum();
        ...
        protected void gdvrdr1_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            else if (e.Parameters.Contains("SRCH"))
            {
                ...
                var obrd = new BRDocument();
                Session["rdr1"] = obrd.Get_OSCSP_SRCH_POR1(obep);
            }
                ...
                if (olist.Count != 0)
                {
                    olist.ForEach(item =>
                    {
                        ...
                        if (band)
                        {
                            ...
                            line.TreeType = "S";
                            line.Father = padre[0];
                            line.NumInBuy = Convert.ToInt32(padre[7]);
                            line.ActivoC = padre[9];
                            line.ActivoS = padre[10];
                            line.LastPurCur = padre[11];
                            band = false;
        ...
        private string Save()
        {
            ...
            if (string.IsNullOrWhiteSpace(_err))
            {
                ...
                {
                    //obrd.SaveUdt(obj, ((BEParameters)Session["InitPar"]).objSapSbo);
                    obrd.SavePurchaseOrder(obj, ((BEParameters)Session["InitPar"]).objSapSbo);
                }
        ...
        private string Modify()
        {
            ...
            if (string.IsNullOrWhiteSpace(_err))
            {
                ...
                //obj.U_BIZ_LUEN = cbbU_BIZ_LUEN.Value.ToString();
                //obj.U_BF_HOEN = cbbU_BF_HOEN.Value.ToString();
                //obj.U_BF_HCFI = (cbbU_BF_HOEN.Value.ToString() == "03") ? tetU_BF_HCFI.Text : string.Empty;
                //obj.U_BF_CODNI = txtConsigDni.Text;
                //obj.U_BIZ_SOLI = txtU_BIZ_SOLI.Text;
                ...
                using (var obrd = new BRDocument())
                {
                    obrd.ModifyPurchaseOrder(obj, ((BEParameters)Session["InitPar"]).objSapSbo);
                }
        ...
        private string Cancel()
        {
            ...
            using (var obrd = new BRDocument())
            {
                obrd.CancelPurchaseOrder(obj, ((BEParameters)Session["InitPar"]).objSapSbo);
            }
        ...
        private string Imprimir()
        {
            ...
            obj.NumAtCard = txtNumAtCard.Text;
            obj.formatoImpresion = "FORMATOORDENCOMPRA";
        ...
        protected void gdvOrdrSearch_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            var obrd = new BRDocument();
            var olst = obrd.Get_OSCSP_SRCH_OPOR(obj);
            Session["ordr"] = olst;
