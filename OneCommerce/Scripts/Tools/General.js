...
function ClearControl() {
    ...
    GroupNum.SetValue(-1);
    ListNum.SetValue(1);
    cbbCurrency.SetValue("##");
    
    cbbCrPersonType.SetValue("TPJ");
    cbbCrDocumentType.SetText("RUC");
    rbtnestado.SetSelectedIndex(0);

    gvcontacto.PerformCallback("CLR");
    gvDirecciones.PerformCallback("CLR");
    gdvClientSearch.PerformCallback("CLR");
...
function Init_ClientCr() {
    ...
    cbbCrDocumentType.BeginUpdate();
    cbbCrDocumentType.ClearItems();
    cbbCrDocumentType.AddItem("RUC", 6);
    cbbCrDocumentType.EndUpdate();
}
