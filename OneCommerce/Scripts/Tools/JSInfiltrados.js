...
//function endcallback_pendientes() {
//    if (hdfTemp.Get("Msg") != "") {
//        alert("" + hdfTemp.Get("Msg"));
//    }
//    else {
//        alert("" + hdfTemp.Get("Msg"));
//    }
...
//function jsenviartodo() {
//    var band = setInterval(function () {
//        var x = hdfTemp.Get("Band");
//        alert(""+x);
//        if (hdfTemp.Get("Band")==true) {
//            alert(hdfTemp.Get("Msg"));
//            clearInterval(band);
//        }
//    },3000);
...
function Get_Plan() {
    ...
    grdvInfiltrados.PerformCallback("INIT");
}
function Get_Plan2() {

    grdvInfiltrados.PerformCallback("CHANGE");
}
...
function Get_InitialData() {
    ...
    {
        type: "POST",
        url: "../Mikrotik/AbonadosInfiltrados.aspx/Get_InitialData",
        data: '{"socied":"' + socied + '"}',
