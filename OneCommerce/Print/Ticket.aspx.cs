    ...
    public partial class Ticket : System.Web.UI.Page
    {
        ...
        private void PrintTicket()
        {
            ...
            layout.GroupBy(dobj => new
            {
                ...
                .ForEach(obj =>
                {
                    var val = Replicate(obj.Key.SubTotal, " ", 24, true);
                    val = Right(val, 24);
                    ...
                    if (!string.IsNullOrWhiteSpace(obj.Key.Discount) && obj.Key.Discount != "0")
                    {
                    ...
                    val = Replicate(obj.Key.VatSum, " ", 26, true);
                    val = Right(val, 26);
                    ...
                    val = Replicate(obj.Key.DocTotal, " ", 24, true);
                    val = Right(val, 24);
