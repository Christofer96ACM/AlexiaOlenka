...
namespace BusinessEntities
{
    public class  BERecursos
    {
        ...
        public DateTime U_DXP_ULT_PAGO { get; set; }
        public string U_DXP_ULT_PAGO1 { get; set; }
        public string U_DXP_FECHA_REG1 { get; set; }
        public string U_DXP_FEC_CORT_INT1 { get; set; }
        public string U_DXP_FEC_CORT_CABLE1 { get; set; }
        ...
        public string FPTx { get; set; }
        public string FPRx { get; set; }
        public string U_U_DXP_DEUDA_ACT { get; set; }

        public Int64 Tx2 { get; set; }
        public Int64 Rx2 { get; set; }
